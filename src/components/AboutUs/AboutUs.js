        ...
        <>
            <div className="about-us">
                <div className="about-us-inform">
                    <div className="about-us-inform-title about-us-title">
                        About us
                    </div>
                    ...
                    <div className="about-us-inform-pale-text about-us-text">
                        ...
                        culpa qui officia reprehenderit in voluptate velit esse
                        cillum dolore eu fugiat nulla pariatur. Excepteur sint
                        occaecat cupidat.
                    </div>
                </div>
                <div className="about-us-authors">
                    <div className="about-us-authors-title about-us-title">
                        Authors
                    </div>
                ...
                <div className="about-us-become-an-author">
                    ...
                    <div className="about-us-become-an-author-text about-us-text">
                        Morbi eget dictum lectus, eget porttitor erat.
                        Vestibulum dictum lacus id turpis egestas mattis.
                        Vestibulum ac leo ultrices, porta libero malesuada,
                        mollis sed.
                    </div>
