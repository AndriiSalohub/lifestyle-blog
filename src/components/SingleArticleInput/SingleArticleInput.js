        ...
        <>
          <div className="single-article-input">
            <div className="single-article-input-title">
              Vivamus posuere dui in congue fringilla elemen tum eleifend ligula
              quis nulla.
            </div>
            <div className="single-article-input-first-block-text text-block">
              <div className="single-article-input-first-block-text-first-paragraph text-block-paragraph">
                Lorem ipsum dolor sit amet sapien leo ac augue nec tincidunt
                vehicula, dui lectus, pellentesque auctor velit. Mauris in wisi.
                Aenean ac sapien. Cras ut erat. Nulla nec elementum vitae,
                vulputate aliquam euismod quam interdum elementum. Morbi quis
                nulla id nulla dictum ante. Donec eu neque tristique vitae,
                pede. Aliquam feugiat mattis faucibus. Sed justo at tellus. Ut
                sodales sapien quis nibh nulla quam nunc, fringilla aliquet.
              </div>
              <div className="single-article-input-first-block-text-second-paragraph text-block-paragraph">
                Ut eget quam molestie justo at nibh lacus, euismod purus eu sem
                sit amet pede. In accumsan orci. Proin aliquam enim ut leo. In
                hac habitasse platea dictumst. Duis neque ac erat. Integer eros
                vulputate at, bibendum vel, wisi. Mauris eros diam magna neque,
                fringilla et, erat. Sed eros. Mauris aliquet quis, justo.
                Vivamus posuere dui. In congue fringilla id, elementum eleifend,
                ligula. Ut eget magna. Donec tempus nulla. Aliquam gravida eros
                sagittis malesuada. Donec nonummy, mi. Donec in faucibus ligula.
                Ut sit amet, sodales dui at metus.
              </div>
            </div>
            ...
            <div className="single-article-input-sub-title">
              Nunc dictum, metus non accumsan congue, felis ex consequat lectus,
              vitae euismod leo lectus vel diam. Aliquam ullamcorper, nisi id
              lacinia tincidunt, elit amet. Aenean sed tempor felis! Nam laoreet
              dui at libero finibus interdum! Maecenas diam velit, molestie
              vitae fringilla ultricies, ultrices eu tortor? Vivamus metus.
            </div>
            <div className="single-article-input-second-block-text text-block">
              ...
              <div className="single-article-input-second-block-text-second-paragraph text-block-paragraph">
                ...
                magnam aliquam quaerat voluptatem. Ut enim ad minim veniam, quis
                nostrud exercitation ullamco laboris nisi ut aliquip ex ea
                commodo consequat. Duis aute irure dolor in reprehenderit in
                voluptate velit esse cillum dolore eu fugiat nulla pariatur.
            ...
            <div className="single-article-input-background-full-title">
              <p className="single-article-input-background-full-title-text">
                Integer tempor id metus et tincidunt. Vestibulum pellentesque
                non massa a fringilla. Mauris aliquet tortor sed ex dignissim
                venenatis.
              </p>
            </div>
            <div className="single-article-input-third-block-text text-block">
              <div className="single-article-input-third-block-text-first-paragraph text-block-paragraph">
                Tempor auctor, ante ipsum consectetuer at, viverra accumsan,
                libero odio a dolor tellus vulputate leo sed ante. Vestibulum
                ante pellentesque quis, pellentesque sagittis vel, consequat
                wisi. Proin posuere. Quisque at nulla. Maecenas eleifend mauris
                rhoncus suscipit. Suspendisse nulla dictum accumsan sed, euismod
                pede, nec dui. Morbi placerat vehicula neque. Praesent in
                vestibulum sed, vestibulum id, elit. Aenean mollis orci. Nullam
                justo facilisis pharetra. Suspendisse sed dolor sit amet
                dignissim massa. Duis mauris consequat sapien mauris vehicula
                ut, consectetuer adipiscing eget, bibendum pede. Vestibulum
                semper convallis. Praesent elit aliquet at, vehicula elit
                consequat auctor non, arcu. In vitae ante. Mauris magna sit
                amet, massa.
              </div>
              <div className="single-article-input-third-block-text-second-paragraph text-block-paragraph">
                Phasellus a laoreet luctus, ante ipsum consectetuer adipiscing
                ligula. Lorem ipsum primis in accumsan sit amet, consectetuer
                massa. Curabitur ac pede. Lorem ipsum primis in risus. Vivamus
                nibh. Etiam et libero. Nullam vulputate sagittis, nunc vel
                ligula accumsan tincidunt. Maecenas semper risus dolor sit amet,
                tempor interdum eu, tempor pede quis leo. Maecenas bibendum
                quis, lacinia aliquet. Quisque vitae metus. Donec congue. Proin
                faucibus orci luctus et nisl. Sed diam eu odio. Morbi.
              </div>
            </div>
          </div>
        </>
